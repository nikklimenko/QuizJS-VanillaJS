...
export class Test {
    ...
    prepareProgressBar() {
        for (let i = 0; i < this.quiz.questions.length; i++) {
            ...
            itemElem.className = 'test-progress-bar-item ' + (i === 0 ? 'active' : '');

            const itemCircleElem = document.createElement('div');
            itemCircleElem.className = 'test-progress-bar-item-circle';


            const itemTextElem = document.createElement('div');
            itemTextElem.className = 'test-progress-bar-item-text';
            itemTextElem.innerText = 'Вопрос ' + (i + 1);

            itemElem.appendChild(itemCircleElem);
            itemElem.appendChild(itemTextElem);

            this.progressBarElement.appendChild(itemElem);
        }
    }
